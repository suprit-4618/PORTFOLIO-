...
const PROJECTS = [
  ...
  },
  {
    ...
    github: null,
    live: null,
    brief: 'An AI-powered smart agriculture ecosystem that provides real-time crop disease detection, weather insights, and market price tracking for farmers.',
    howItWorks: 'The platform uses a MobileNetV2-based CNN model for crop disease detection via image uploads or live camera. It integrates multiple APIs for real-time weather and market data, and features a certification-based direct-to-consumer marketplace.',
    why: 'Developed to unify fragmented agricultural data into a single, accessible platform, improving decision-making and efficiency for rural farmers.',
    problemSolves: [
      'Reduces dependency on intermediaries through direct selling',
      'Enables early crop disease detection, minimizing losses',
      'Improves planning with accurate weather and market insights',
    ],
    limitations: [
